...
# ⚠ SUPERSEDED (2026-07-26): 本脚本读取的 PA_table_ortho.tsv 是 40 kb 窄窗口假象的产物，
#   其绘出的"ZN65 特异插入"口径已被 07_分析_Os02g基因鉴定/24_OsB2复合结构确证/ 推翻。
#   现行权威数据: 24_OsB2复合结构确证/report/PA_table_v2_copynumber_20260722.tsv
#   （block A 在 ZN65 3 拷贝、六个对照各 1 拷贝；该片段在所有受检基因组中都存在）。
#   Paper1 定稿的 Fig 4 由 _改写v2_LINE关联_20260722/figures/make_Fig4_v2.R 生成；
#   本脚本仅作历史留痕，**不得再用于生成对外图件**。
import sys,os
